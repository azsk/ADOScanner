...
### Contribution areas
You can contribute to the ADO Scanner project through blogs, documentation, or code. 
...
### Reporting issues
Have you identified a reproducible bug in the ADO Scanner? We want to hear about it! Here's how you can make reporting your issue as effective as possible.

#### Look for an existing issue
Before creating a new issue, search in [issues](https://github.com/azsk/ADOScanner/issues) to see if the issue has already been created.
...
* Always specify the AzSK.ADO version for which you faced the issue.
