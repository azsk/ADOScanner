...
Invoke-Expression "enum ResourceTypeName { `r`n All `r`n $([SVTMapping]::GetResourceTypeEnumItems())`r`n Org_Project_User `r`n Build_Release `r`n Build_Release_SvcConn_AgentPool_VarGroup_User_CommonSVTResources `r`n SvcConn_AgentPool_VarGroup_CommonSVTResources `r`n}";
